...
import { FiCheckCircle, FiEdit, FiTrash2, FiAlertTriangle } from "react-icons/fi";
import Modal from "./Modal";

export default function TodoItem({ todo, index = 0, onToggleTodo, onEditTodo, onDeleteTodo }) {
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-6 flex w-full flex-col gap-2.5 sm:flex-row sm:justify-center">
            ...
            <button
              ...
              className="flex-1 rounded-2xl bg-gradient-to-r from-[#e66c4c] to-[var(--amber-500)] px-5 py-3.5 text-sm font-extrabold text-white shadow-md shadow-[#e66c4c30] transition duration-300 hover:-translate-y-0.5 hover:from-[#d55837] hover:to-[#d66f3b] focus:outline-none"
            >
              Delete
            </button>
          </div>
